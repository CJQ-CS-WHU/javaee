        ...
        <el-col :span="6"><div class="grid-content bg-purple">
            ...
            <div v-for="task in doneArray" :key="task.id"   class="card">
               <el-card v-bind:class="task.taskId" v-bind:id="task.taskExecutor.userId+'in'+task.taskId">
                    ...
                    <div class="date">
                        {{task.taskBeginTime+" ~ "+task.taskEndTime}}
                    </div>
                    <div class = "priority" v-bind:id="task.taskPriority">
                        <span >{{'优先级：'}}</span><span >{{task.taskPriority}}</span>
                    </div>
...
export default {
    ...
    data () {
      return {
        visible: false,
        allTaskArray:[{"id":"1","taskId": "1","taskPriority":"紧急","taskRemark":"任务一", "taskBeginTime":"2020-02-02", "taskEndTime":"2020-09-05", "taskExecutor" :{"userId":"11","userName":"小红"}}],
        readyArray:[{"id":"1","taskId": "1","taskPriority":"紧急","taskRemark":"任务一", "taskBeginTime":"2020-02-02", "taskEndTime":"2020-09-05", "taskExecutor" :{"userId":11,"userName":"小红"}},
        {"id":"2","taskId": "2","taskPriority":"紧急","taskRemark":"任务二", "taskBeginTime":"2020-05-02", "taskEndTime":"2021-03-05", "taskExecutor" :{"userId":13,"userName":"小勇"}},
        {"id":"4","taskId": "4","taskPriority":"一般","taskRemark":"任务四", "taskBeginTime":"2020-08-02", "taskEndTime":"2021-02-05", "taskExecutor" :{"userId":12,"userName":"小明"}},
        {"id":"5","taskId": "5","taskPriority":"较低","taskRemark":"任务五", "taskBeginTime":"2020-02-02", "taskEndTime":"2021-05-05", "taskExecutor" :{"userId":11,"userName":"小红"}}],
        doningArray:[{"id":"7","taskId": "7","taskPriority":"较低","taskRemark":"任务七", "taskBeginTime":"2020-08-02", "taskEndTime":"2021-10-05", "taskExecutor" :{"userId":13,"userName":"小勇"}},
        {"id":"8","taskId": "8","taskPriority":"一般","taskRemark":"任务八", "taskBeginTime":"2020-01-07", "taskEndTime":"2021-04-05", "taskExecutor" :{"userId":12,"userName":"小明"}}],
        testingArray:[{"id":"9","taskId": "9","taskPriority":"一般","taskRemark":"任务九", "taskBeginTime":"2020-04-02", "taskEndTime":"2020-06-05", "taskExecutor" :{"userId":13,"userName":"小勇"}}],
        doneArray:[{"id":"3","taskId": "3","taskPriority":"紧急","taskRemark":"任务三", "taskBeginTime":"2020-03-15", "taskEndTime":"2020-09-05", "taskExecutor" :{"userId":11,"userName":"小红"}},
        {"id":"6","taskId": "6","taskPriority":"一般","taskRemark":"任务六", "taskBeginTime":"2020-06-02", "taskEndTime":"2021-10-05", "taskExecutor" :{"userId":12,"userName":"小明"}}],
        priorityId:""
      }
    },
    computed:{
