...
<!--修改迭代的弹框-->
 <el-dialog
    ...
    <!--迭代显示-->
    <el-table :data="iterationVOs.slice((currentPage-1)*pagesize,currentPage*pagesize)" border="true" style="width: 100%" height="400">
  ...
  mounted () {
    ...
    axios({
      ...
      Response.data.data.forEach(element => {
        ...
        this.total = this.iterationVOs.length
      })
    })
  },
  data () {
